...
const Footer = () => {
  return (
    <footer className="text-gray-600  border-t-2 rounded-t-xl border-gray-300 font-nunito select-none">
        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 ">
              <li>
                <a className="text-gray-600 cursor-pointer hover:text-blue-400">
                  First Link
                </a>
              </li>
              <li>
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              ...
              <button className="uppercase lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">
                Submit
              </button>
            </div>
      ...
      <div className="bg-gray-100">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <div className="flex items-center ml-5 group cursor-pointer">
            <Link href="/">
